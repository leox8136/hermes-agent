...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Hermes がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/leox8136/hermes-agent/current-ops/scripts/install.sh | sh）か、Hermes パスを設定してください。',
      sshErrPlatform:
