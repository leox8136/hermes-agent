...
export const fr = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        "Hermes n'est pas installé sur l'hôte distant. Installez-le là-bas (curl -fsSL https://raw.githubusercontent.com/leox8136/hermes-agent/current-ops/scripts/install.sh | bash) ou définissez le chemin Hermes.",
      sshErrPlatform:
