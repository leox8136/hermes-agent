...
def _patch_update_deps(monkeypatch, tmp_path, run_side_effect):
    ...
    # These probes return fixed snapshots; waiting cannot make a missing runtime appear.
    monkeypatch.setattr(update_cmd_fleet, "_FLEET_PROBE_SETTLE_TIMEOUT_SECONDS", 0)
